...
app.factory('AddItemFactory', function ($resource, $location) {
    return $resource(($location.protocol() + "://" + $location.host() + ":" + $location.port()) + '/stocks/:id',{}, {
    	add_item: { method: 'POST' }
    });
});
app.factory('DeleteItemFactory', function ($resource, $location) {

    return $resource(($location.protocol() + "://" + $location.host() + ":" + $location.port()) + '/stocks0/:id',{}, {
